        ...
        >
            <div className='relative p-4 w-full max-w-md max-h-full'>
                <div className='relative bg-white rounded-lg shadow dark:bg-neutral-800 p-3 space-y-3'>
                    ...
                    <div>
                        <h3 className='mb-2 text-xl dark:text-white font-medium'>คุณต้องการลบประเภทสินค้า { categoryName } นี้หรือไม่</h3>
                        {/* <p className='pb-2 dark:text-white'></p> */}
                    </div>
                    <div className='grid grid-cols-2 gap-3'>
                        <button
                            type='button'
                            onClick={() => closeModal('confirm-category-modal')}
                            className='z-50 text-gray-500 bg-white hover:bg-neutral-100 focus:ring-4 focus:outline-none focus:ring-neutral-200 rounded-lg border border-neutral-200 text-sm font-medium px-5 py-2.5 hover:text-neutral-900 focus:z-10 dark:text-neutral-300 dark:border-neutral-500 dark:hover:text-white dark:hover:bg-neutral-600 dark:focus:ring-neutral-600'
                        >
                            ยกเลิก
                        </button>
                        <button
                            type='button'
                            className='z-50 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2'
